...
BT.editChannel("464756554139172901", {name : "🌹WEL"})
BT.editChannel("464756554139172901", {name : "🌹WELC"})
BT.editChannel("464756554139172901", {name : "🌹WELCO"})
BT.editChannel("464756554139172901", {name : "🌹WELCOM"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME T"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME TO"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME TO N"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME TO NO"})
BT.editChannel("464756554139172901", {name : "🌹WELCOME TO NO 🌹"})
...
client.on("guildMemberAdd", member => {
  ...
  return channel.send(`وِ̨ۄڵــﯖــمۘ ּنۨــﯜڕټ ڛۣــﯧْۧــڕڣــڕنۨــٰ̍ا̍ ۖ ٺــڣــٰٱ̍؏ــڶ ۛ ּﯡچۚــۑْۧــب ̨ا̍ڝــدڦــٰا̍ئــک ا̍نۨــڜــٰٱ̍ءﷲ ۖ ﷻ ۖ بــٿــڛۣــٺــمۘــٿــ؏ ̨مۘــ؏ــڼۨــٰ̍ا̍ ۗ🌹  ${member} `) 
}).catch(console.error)
...
client.on('message', message => {
    if(message.content === 'باك'){
        message.channel.send(' - ۛ ּ 🌹`ۏڶــڪــمۭ ּ, ۛ ּڀــحۡــڷــﯣۥ ּمۭــنۨ ̨ژمۭــٰٱ̍نۨ ۖ ؏ــڼۨــک ּڪــڼۨــٺ ̨ۄڀــنۨ مۭــنۨ ڗمۭــٰٱ̍نۨ ۗ')
    }
});
client.on('message', message => {
    if(message.content === 'برب'){
        message.channel.send('🌹` ּٺــېْۧــٺــﷲ ۖ ﷻ ۛ ּمۭــ؏ــڪ ڀــحۡــڸــﯜۥ ּﻻ̍ۙٺــطــﯜڷــ,ــءہ ۗ')
    }
});
